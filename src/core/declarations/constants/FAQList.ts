...
export const FAQList: Array<IFaq> = [
    ...
    {
        question: "WHAT PRODUCTS DOES Technance PROVIDE?",
        answer: "Technance provides a comprehensive trading platform featuring spot trading, perpetual contracts, advanced charting tools, portfolio management, and mobile trading capabilities. We offer access to hundreds of cryptocurrencies and trading pairs with competitive fees and professional-grade features."
    },
    {
        question: "HOW TO BUY BITCOIN ON Technance?",
        answer: "To buy Bitcoin on Technance: 1) Create and verify your account, 2) Deposit funds via bank transfer, credit card, or other supported methods, 3) Navigate to the Bitcoin trading pair, 4) Choose your order type (market or limit), 5) Enter the amount and confirm your purchase. Your Bitcoin will be credited to your account instantly."
    },
    {
        question: "HOW TO TRADE CRYPTOCURRENCIES ON Technance?",
